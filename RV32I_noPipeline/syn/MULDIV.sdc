## Generated SDC file "DIVrest32u.out.sdc"
...
set_input_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {funct3_i[0]}]
set_input_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {funct3_i[1]}]
set_input_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {funct3_i[2]}]
